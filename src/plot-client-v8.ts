...
const generateCircleTexture = (
  ...
  circle.fill(pixiColor); // Change the fill color to white
...
export class PlotClient {
  ...
  private drawBorder(): void {
    this.pBorder.clear();
    this.pBorder.rect(0, 0, this.width, this.height);
    this.pBorder.stroke({width: 1, color: 0x000000}); // Change the color to black
  }
